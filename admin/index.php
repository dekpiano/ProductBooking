...
$pageTitle = 'SB Admin 2 - หน้าหลัก'; // Set page title
include '_head.php';
?>
            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <p>ยินดีต้อนรับสู่แผงควบคุมผู้ดูแลระบบ ที่นี่คุณสามารถจัดการสินค้าและคำสั่งซื้อได้</p>
                            <a href="products.php" class="btn btn-primary">ไปยังหน้าสินค้า &rarr;</a>
                            <a href="orders.php" class="btn btn-success">ไปยังหน้าคำสั่งซื้อ &rarr;</a>
                        </div>
                    </div>
                </div>
            </div>
